...
char const* const _PREHASH_RequestImage = LLMessageStringTable::getInstance()->getString("RequestImage");  // OpenSim compatibility
...
char const* const _PREHASH_ImagePacket = LLMessageStringTable::getInstance()->getString("ImagePacket");  // Opensim compatibility
...
char const* const _PREHASH_ImageData = LLMessageStringTable::getInstance()->getString("ImageData");  // OpenSim compatibility
